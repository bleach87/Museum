...
public class HtmlHeaderServlet extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
	...
	out.println("<link rel='stylesheet' type='text/css' href='" + webAppPath +	"/css/default.css' />");
	out.println("<link rel='stylesheet' type='text/css' href='" + webAppPath + 	"/css/component.css' />");
	
	out.println(" <link rel='stylesheet' type='text/css' href='" + webAppPath +  	"/css/slide_demo.css' />");
	out.println(" <link rel='stylesheet' type='text/css'href='" + webAppPath + 		"/css/slide_style.css' />");
